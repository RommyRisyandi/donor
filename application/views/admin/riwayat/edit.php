<section class="content">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>UBAH RIWAYAT DONOR</h2>
                </div>
                <?php echo form_open('admin/aedit_r', 'class="form-horizontal"'); ?>
                <div class="body">
                    <!-- row start -->
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" name="id_donora" value="<?php echo $r->id_donor; ?>" placeholder="Masukan Nomor RM..." readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" name="nama" value="<?php echo $r->nama; ?>" placeholder="Masukan Nama Pendonor..." required autofocus>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
