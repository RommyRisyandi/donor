    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <?php echo form_open('admin/atambah_s', 'class="form-horizontal"'); ?>
                <div class="body">
                    <!-- row start -->
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" name="kode_darah" placeholder="Masukan Kode Darah..." required autofocus>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
